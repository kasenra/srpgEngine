...
func initialize(walkable: Array, map:BattleMap, u:Unit) -> void: ## Prepares the pathfinding grid for a unit's walkable and moveType
	pathfinder.prepare(walkable, map, u)
